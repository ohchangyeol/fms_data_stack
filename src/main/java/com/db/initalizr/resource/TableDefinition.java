package com.db.initalizr.resource;
...
public enum TableDefinition {
    ...
    TableDefinition(String schema, int increaseMonth, int baseCount, int storageDuration) {
        this.schema = schema;
    ...
    public static TableDefinition findByNameAndSchema( String schema, String name) {
        return Arrays.stream(TableDefinition.values())
