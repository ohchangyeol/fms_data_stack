...
public class ConfigDrivenGenerator {
    ...
    public void process(Config config, List<Tuple> results, String partition) {
    ...
    private List<String> resolveColumns(Config config) {
    ...
    private String buildInsertSql(Config config, List<String> columns) {
